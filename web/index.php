      ...
      <div class="container">
         <div class="row">
          <div class="col-lg-8 col-lg-offset-2">
            <h4 class="text-center">В случае если у Вас есть вопросы или пожелания - зарегистрируйтесь и оставьте свое сообщение </h4>
               ...
               <div class="row">
                 <div class="col-md-6">
                   <div class="form-group">
                      <label for="form_name">Ваша фамилия</label>
                      <input id="form_name" type="text" name="name" class="form-control" placeholder="Пожалуйста, введите Вашу фамилию" required="required" data-error="Firstname is required.">
                      <div class="help-block with-errors"></div>
                   </div>
                 </div>
                 <div class="col-md-6">
                    <div class="form-group">
                       <label for="form_lastname">Ваше имя</label>
                       <input id="form_lastname" type="text" name="surname" class="form-control" placeholder="Пожалуйста, введите Ваше имя" required="required" data-error="Lastname is required.">
                       <div class="help-block with-errors"></div>
                    </div>
                 </div>
               </div>
               <div class="row">
                  <div class="col-md-6">
                     <div class="form-group">
                       ...
                       <input id="form_email" type="email" name="email" class="form-control" placeholder="Пожалуйства введите Ваш e-mail" required="required" data-error="Valid email is required.">
                       <div class="help-block with-errors"></div>
                     </div>
                   </div>
                 <div class="col-md-6">
                    <div class="form-group">
                     ...
                     <input id="form_phone" type="tel" name="phone" class="form-control" placeholder="Пожалуйста, введите Ваш номер телефона">
                     <div class="help-block with-errors"></div>
                   </div>
                 </div>
               </div>
